...
void work(String rfid,String name)
 {
  digitalWrite(2,HIGH);
  EEPROM.writeString(count,rfid);
    count = count + 11;
    Serial.print("\t"+name+"\t");
    EEPROM.writeString(count,+"\t"+name+"\t") ;
    count = count+7;
...
void loop() {
  ...
  if (content.substring(1) == "03 6F CD 73") //change here the UID of the card/cards that you want to give access
  {
   ...
   work(content.substring(1),"rajan");
  }
...
else if (content.substring(1) == "D2 A0 38 1B") //change here the UID of the card/cards that you want to give access
  {
    work(content.substring(1),"rajan");
   }
   
else if (content.substring(1) == "69 C5 9E 77") //change here the UID of the card/cards that you want to give access
  {
    work(content.substring(1),"rajan");
   }
   
else if (content.substring(1) == "A9 68 70 43") //change here the UID of the card/cards that you want to give access
  {
    work(content.substring(1),"rajan");
   }
   
else if (content.substring(1) == "2A B6 1B 29") //change here the UID of the card/cards that you want to give access
  {
    work(content.substring(1),"rajan");
   }
   
else if (content.substring(1) == "CB 1A FA 66") //change here the UID of the card/cards that you want to give access
  {
    work(content.substring(1),"rajan");
   }
   
else if (content.substring(1) == "8A 78 AA 08") //change here the UID of the card/cards that you want to give access
  {
    work(content.substring(1),"rajan");
   }
   
else if (content.substring(1) == "1B 90 0D 21") //change here the UID of the card/cards that you want to give access
  {
    work(content.substring(1),"rajan");
   }
   
else if (content.substring(1) == "BC 31 53 43") //change here the UID of the card/cards that you want to give access
  {
    work(content.substring(1),"rajan");
   }
   
else if (content.substring(1) == "CE 03 1C D3") //change here the UID of the card/cards that you want to give access
  {
    work(content.substring(1),"rajan");
   }
